...
$$
l \propto \Bigg\{ h^{1/2} \exp \Bigg[-\frac{h}{2}(\beta - \hat{\beta})^2\sum_{i = 1}^N x_i^2\Bigg]\Bigg\} \Bigg\{h^\frac{\nu}{2}\exp{\Bigg[\frac{-h\nu}{2\sigma^{-2}}\Bigg]}\Bigg\}
$$

The prior

$$
\pi(\theta) \propto h^{a - 1} \exp{-bh} h^{1/2} \exp{-\frac{1}{2}\frac{h}{V}(\beta -d)^2}
$$
